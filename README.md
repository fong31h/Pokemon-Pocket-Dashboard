...
Lastly, while this may not be the most business-relevant project, 

# What I learned

* Game data like this is complicated, with endless edge cases and unexpected problems that have to be accounted for
